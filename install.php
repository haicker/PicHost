...
<<<<<<< HEAD
    ...
    $configContent = str_replace(
        ...
        "define('ADMIN_PASSWORD', '" . addslashes($hashedPassword) . "');",
        $configContent
    );

    $data['base_url'] = !empty($data['base_url']) ? $data['base_url'] : getCurrentBaseUrl();

    $baseUrlLine = "define('BASE_URL', '" . addslashes($data['base_url']) . "');";
